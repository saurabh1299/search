...
public class TestNG_sample_code {
ChromeDriver driver;
@BeforeTest

public void prerequisite(XmlTest xmlTest)
{
System.out.println("within the before class");
String b = xmlTest.getParameter("browser");
if(b.equals("GC"))
{
